...
const Contact = () => {
    return (
        <div id='contact' className='w-full lg:h-screem'>
                    ...
                    <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
                        <div className='lg:p-4 h-full'>
                            ...
                            <div>
                                ...
                                <p className='py-4'>
                                    I am availabe for freelance work or full-time positions. Contact me for more information.
                                </p>
                            </div>
                            <div>
                    ...
                    <div className='col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4'>
                        <div className='p-4'>
                            <form>
                                ...
                                <button className='w-full font-medium p-4 mt-4'>
                                    Send Message
                                </button>
                            </form>
                        </div>
